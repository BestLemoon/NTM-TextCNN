...
parser.add_argument('--taskname', type=str, default='weibotest', help='Taskname e.g cnews10k')
...
def main():
    ...
    if ckpt:
        ...
        param = {"bow_dim": voc_size, "n_topic": n_topic, "taskname": taskname, "device": device}
